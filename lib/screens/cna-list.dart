...
class CnaListScreen extends StatefulWidget {
  const CnaListScreen({Key? key}) : super(key: key);

  @override
  _CnaListScreenState createState() => _CnaListScreenState();
}

class _CnaListScreenState extends State<CnaListScreen> {
  late List<Map<String, dynamic>> cssData;

  @override
  void initState() {
    cssData = dictionaryData
          ...
          child: Column(
            ...
            children: [
              Column(
                children: [
                  Image.asset(
                    'lib/assets/cisco-icon.png', // Adjust the path as needed
              ...
              Text(
                'In need for a CLI cheat sheet dictionary for CNA Routing? Here you go! Quickly access CNA Routing command-line references on the go.',
                style: TextStyle(
                  fontSize: 16.0,
                  fontFamily: GoogleFonts.poppins().fontFamily,
                ),
